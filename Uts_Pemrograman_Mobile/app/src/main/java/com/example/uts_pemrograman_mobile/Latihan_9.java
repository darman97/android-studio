...
public class Latihan_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_9);
    ...
    private void B_Submit(){
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Latihan_9.this,pesan,Toast.LENGTH_LONG).show();
            }
        });
    }
    private void B_Exit(){
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(Latihan_9.this);
