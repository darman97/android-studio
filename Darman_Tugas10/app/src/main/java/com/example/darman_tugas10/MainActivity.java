...
public class MainActivity extends AppCompatActivity {
    ...
    EditText Password;
    private String[] List_Username = {"admin","agus","akmal","almaira","amanda","anindiva,darman"};
    Button Tombol;
